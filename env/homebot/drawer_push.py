...
class DrawerPushEnv(BaseEnv):
    def __init__(
        ...
        self.reset_joint_values = np.array(
            ...
            [-0.13, 0.64, 0.63, -2.36, -1.36, 1.15, 2.21]
        )
    ...
    def reset(self, seed: int = None, options: dict = None, obj_list: List = None):
        ...
        if self.domain_randomize:
            ...
            # drawer
            drawer_rand = self.np_random.uniform(-0.5, 0.5, (3,))
            ...
            self.drawers[1].set_qpos(torch.tensor([0.1]))
    ...
    def compute_dense_reward(self, drawer_id=1):
        ...
        # print("robot_pos:", self.robot.get_qpos())
