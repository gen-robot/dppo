...
def get_checkpoint_download_url(cfg):
    ...
    if (
        ...
        "ant-medium-expert-v0_pre_diffusion_mlp_ta4_td20/2025-03-29_20-19-29_42/checkpoint/state_6_700.pt"
        in path
    ):
        return "https://drive.google.com/drive/folders/1K2HgTTUJzs8knfqDBtELzLmY8DK6Of20"
    # Demo-RL
    elif (
